...
object SampleHousehold {
    ...
    private fun expense(id: Long, name: String, group: Long, timing: Timing, flexible: Boolean = false, tracking: TrackingMode = TrackingMode.AUTO) =
     ...
     * 生活費・現金 4,400、生活費・信用卡 9,800、交通油資・信用卡 2,300、家用・現金 300。
     */
